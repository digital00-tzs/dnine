                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="space-y-6 ">
                    <div className="space-y-2 mb-10 ">
                      ...
                      <p className="text-2xl   text-muted-foreground">Category</p>
                    </div>
                    <div className="space-y-4">
                      <p className="text-3xl  mb-10 font-bold">₹ 5000</p>
                      <button className="bg-[#0D0C22] text-white hover:bg-[#1D1C32] px-8 py-3 text-lg rounded-md">
                        BUY NOW
                      </button>
                    </div>
                  </div>
                  <div className="flex mt-24 relative top-10  justify-center">
                    <img
