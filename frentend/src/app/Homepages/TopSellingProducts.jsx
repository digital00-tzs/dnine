          ...
          {displayedProducts.map((product, index) => (
            ...
            >
              ...
              <div className="flex flex-col p-3 w-full max-md:max-w-full">
                <div className="flex-1 shrink gap-2.5 self-stretch w-full text-2xl leading-tight text-slate-900 max-md:max-w-full">
                  FIRST White Men's Running Shoes
                </div>
                <div className="flex flex-row gap-10 justify-between items-center mt-3 w-full max-md:max-w-full">
                  <div className="gap-2 self-stretch my-auto text-2xl leading-tight text-black min-w-[240px]">
                  ...
                  <div className="flex items-start self-stretch my-auto text-lg font-medium leading-loose text-rose-600 whitespace-nowrap">
                    <div className="gap-4 self-stretch px-5 py-1.5 rounded-lg border border-rose-600 border-solid">
                      {product.discount}
                    </div>
                  </div>
                </div>
